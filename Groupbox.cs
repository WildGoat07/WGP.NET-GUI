...
namespace WGP.Gui
{
    public class Groupbox : Widget
    {
        ...
        protected override void InternUpdate()
        {
            ...
            Border[5].Position = new Vector2f(ReservedSpace.Left + 15 + Label.GetGlobalBounds().Width, (int)ReservedSpace.Top + .5f + Init.TextSize / 2) + Padding;
        ...
        internal override Vector2f GetMinimumSize()
        {
            ...
            float minW = Label.GetGlobalBounds().Width + 20;
            if (Content != null)
